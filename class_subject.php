			...
			<div class="col-md-12">
				<div class="card">
					<div class="card-header">
						<b>Liste de classe par matiere</b>
							...
							<tbody>
								...
								<tr>
									...
									<td class="text-center">
										<button class="btn btn-sm btn-outline-primary edit_class_subject" type="button" data-id="<?php echo $row['id'] ?>" >Modifier</button>
										<button class="btn btn-sm btn-outline-danger delete_class_subject" type="button" data-id="<?php echo $row['id'] ?>">Supprimer</button>
									</td>
								</tr>
								<?php endwhile; ?>
							</tbody>
