			...
			<form action="" id="manage-course">
				<div class="card">
					...
					<div class="card-footer">
						<div class="row">
							<div class="col-md-12">
								<button class="btn btn-sm btn-primary col-sm-3 offset-md-3"> Enregister</button>
...
<script>
	...
	$('#manage-course').submit(function(e){
		...
		$.ajax({
			...
			success:function(resp){
				...
				$('#msg').html('<div class="alert alert-danger mx-2">Cours deja present.</div>')
				end_load()
				}			
			}
		})
	...
	$('.delete_course').click(function(){
		_conf("Etes-vous sure de vouloir supprimer ce cours?","delete_course",[$(this).attr('data-id')])
	})
	function delete_course($id){
		...
		$.ajax({
			...
			success:function(resp){
				if(resp==1){
					alert_toast("Donnée supprimer avec succès",'success')
					setTimeout(function(){
						location.reload()
					},1500)
