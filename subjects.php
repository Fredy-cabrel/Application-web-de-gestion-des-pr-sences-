...
<script>
	...
	$('#manage-subject').submit(function(e){
		...
		$.ajax({
			...
			success:function(resp){
				...
				$('#msg').html('<div class="alert alert-danger mx-2">chapitre deja utiliser.</div>')
				end_load()
				}				
			}
		})
	...
	$('.delete_subject').click(function(){
		_conf("Etes-vous sure de vouloir supprimer ce chapitre?","delete_subject",[$(this).attr('data-id')])
	})
