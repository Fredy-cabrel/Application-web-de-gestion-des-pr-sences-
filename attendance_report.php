...
<div class="container-fluid">
	<div class="col-lg-12">
		<div class="card">
			<div class="card-header"><b>Rapport de presence</b></div>
			<div class="card-body">
				<form id="manage-attendance">
					<input type="hidden" name="id" value="">
					<div class="row justify-content-center">
						<label for="" class="mt-2">Classe par matiere</label>
						<div class="col-sm-4">
						...
						<label for="" class="mt-2">Mois de</label>
						<div class="col-sm-3">
							<input type="month" name="doc" id="doc" value="<?php echo date('Y-m') ?>" class="form-control">
						</div>
						<div class="col-sm-2">
							<button class="btn  btn-primary" type="button" id="filter">Filtrer</button>
						</div>
					</div>
					<hr>
					<div class="row">
						<div class="col-md-12" id='att-list'>
							<center><b><h4><i>Veuillez selectionner la classe</i></h4></b></center>
						</div>
	...
	<table width="100%">
		<tr>
			<td width="50%">
				...
				<p>Nombre total de jour de cours: <b class="noc"></b></p>
			</td>
			<td width="50%">
				<p>Classe: <b class="class"></b></p>
				<p>Mois de: <b class="doc"></b></p>
			</td>
		</tr>
	</table>
