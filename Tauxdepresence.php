...
<div class="container-fluid">
	<div class="col-lg-12">
		<div class="card">
			<div class="card-header"><b>Dossier_de_presence</b></div>
			<div class="card-body">
				<form id="manage-attendance">
					<input type="hidden" name="id" value="">
					<div class="row justify-content-center">
						<label for="" class="mt-2">Classe_par_matiere</label>
						<div class="col-sm-4">
					...
					<div class="row">
						<div class="col-md-12" id='att-list'>
							<center><b><h4><i>Veuillez_selectionnez_la_classe</i></h4></b></center>
						</div>
						<div class="col-md-12"  style="display: none" id="submit-btn-field">
							<center>
								<button class="btn btn-primary btn-sm col-sm-3" type="button" id="edit_att"><i class="fa fa-edit" data-id=''></i> Modifier</button>
								<button class="btn btn-success btn-sm col-sm-3" type="button" id="print_att"><i class="fa fa-print"></i> Imprimer</button>
							</center>
						</div>
					</div>
				</form>
...
<div id="table_clone" style="display: none">
	<table width="100%">
		<tr>
			<td width="50%">
				<p>Cours: <b class="course"></b></p>
				<p>Sujet: <b class="subject"></b></p>
			</td>
			<td width="50%">
				<p>Classe: <b class="class"></b></p>
				<p>Date de classe: <b class="doc"></b></p>
			</td>
		</tr>
	</table>
...
<div id="chk_clone" style="display: none">
	<div class="d-flex justify-content-center chk-opts">
		...
		<div class="form-check form-check-inline">
		  ...
		  <label class="form-check-label late-lbl">Retard</label>
		</div>
	</div>
</div>
<style>
...
<script>
	...
	$('#manage-attendance').submit(function(e){
		...
		$.ajax({
			...
			success:function(resp){
				if(resp==1){
					  alert_toast("Donnée sauvegarder avec succès.",'success')
                        setTimeout(function(){
                            location.reload()
                        },1000)
				}else if(resp ==2){
					  alert_toast("La classe a deja un registre de presence avec le sujet et la date selectionner.",'Danger')
					  end_load();
				}
			}
		})
